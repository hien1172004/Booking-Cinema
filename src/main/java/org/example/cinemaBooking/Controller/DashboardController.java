...
public class DashboardController {
    ...
    @Operation(summary = "Lấy tổng quan dashboard",
            description = "Lấy tổng quan về doanh thu, số lượng vé bán ra, số lượng khách hàng, và số lượng suất chiếu của hôm nay")
    ...
    @Operation(summary = "Lấy biểu đồ doanh thu 7 ngày",
            description = "Lấy dữ liệu doanh thu của 7 ngày gần nhất để hiển thị biểu đồ trên dashboard")
    @SecurityRequirement(name = "bearerAuth")
    @PreAuthorize("hasRole('ADMIN')")
