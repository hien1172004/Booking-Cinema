...
public class StatisticsController {
        ...
        @Operation(summary = "Lấy tổng quan thống kê", description = "Lấy tổng quan về doanh thu, số lượng vé bán ra theo boi lọc theo ngày, tháng, năm, hoặc theo rạp")
        ...
        @Operation(summary = "Lấy biểu đồ doanh thu", description = "Lấy dữ liệu doanh thu theo bộ lọc theo ngày, tháng, năm, hoặc theo rạp để hiển thị biểu đồ ")
        @SecurityRequirement(name = "bearerAuth")
        @PreAuthorize("hasRole('ADMIN')")
        ...
        @Operation(summary = "Lấy biểu đồ vé bán ra", description = "Lấy dữ liệu số lượng vé bán ra theo bộ lọc theo ngày, tháng, năm, hoặc theo rạp để hiển thị biểu đồ ")
        @SecurityRequirement(name = "bearerAuth")
        @PreAuthorize("hasRole('ADMIN')")
        ...
        @Operation(summary = "Lấy top phim", description = "Lấy danh sách top phim theo số lượng vé bán ra theo bộ lọc theo ngày, tháng, năm, hoặc theo rạp")
        @SecurityRequirement(name = "bearerAuth")
        @PreAuthorize("hasRole('ADMIN')")
