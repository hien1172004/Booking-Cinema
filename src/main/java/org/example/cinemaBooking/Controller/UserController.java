...
public class UserController {
        ...
        @Operation(summary = "Lấy thông tin người dùng hiện tại", description = "Trả về thông tin hồ sơ của người dùng đang đăng nhập.", security = @SecurityRequirement(name = "bearerAuth"))
        ...
        @Operation(summary = "Cập nhật hồ sơ", description = "Cập nhật thông tin hồ sơ của người dùng đang đăng nhập.", security = @SecurityRequirement(name = "bearerAuth"))
        ...
        @Operation(summary = "Đổi mật khẩu", description = "Cho phép người dùng đang đăng nhập thay đổi mật khẩu của mình.", security = @SecurityRequirement(name = "bearerAuth"))
        ...
        @Operation(summary = "Cập nhật avatar", description = "Cập nhật ảnh đại diện của người dùng.", security = @SecurityRequirement(name = "bearerAuth"))
        ...
        @Operation(summary = "Khóa người dùng (ADMIN)", description = "Khóa tài khoản người dùng theo id (chỉ ADMIN).", security = @SecurityRequirement(name = "bearerAuth"))
        ...
        @Operation(summary = "Mở khóa người dùng ", description = "Mở khóa tài khoản người dùng theo id.", security = @SecurityRequirement(name = "bearerAuth"))
        ...
        @Operation(summary = "Lấy người dùng theo id", description = "Lấy thông tin chi tiết của người dùng theo id.", security = @SecurityRequirement(name = "bearerAuth"))
        @GetMapping("/{id}")
        @PreAuthorize("hasRole('ADMIN')")
        ...
        @Operation(summary = "Lấy người dùng theo username ", description = "Lấy thông tin người dùng theo username.", security = @SecurityRequirement(name = "bearerAuth"))
        @GetMapping("/{username}")
        @PreAuthorize("hasRole('ADMIN')")
        ...
        @Operation(summary = "Lấy danh sách người dùng", description = "Lấy danh sách người dùng theo phân trang và tìm kiếm.", security = @SecurityRequirement(name = "bearerAuth"))
        @GetMapping
        @PreAuthorize("hasRole('ADMIN')")
        ...
        @Operation(summary = "Tạo người dùng (ADMIN)", description = "Tạo tài khoản người dùng mới (chỉ ADMIN).", security = @SecurityRequirement(name = "bearerAuth"))
        @PostMapping
        @PreAuthorize("hasRole('ADMIN')")
        ...
        @Operation(summary = "Lấy danh sách nhân viên", description = "Lấy danh sách nhân viên theo phân trang và tìm kiếm.", security = @SecurityRequirement(name = "bearerAuth"))
